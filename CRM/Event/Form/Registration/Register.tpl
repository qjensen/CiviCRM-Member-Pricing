...
{if $paidEvent}
    ...
    <script language="javascript">
      ...
      function copyAddress(sameAsBilling) {
        ...
        var streetAddress = document.getElementById('street_address-Primary').value;
        var city = document.getElementById('city-Primary').value;
        var stateProvince = document.getElementById('state_province-Primary').value;
        var postalCode = document.getElementById('postal_code-Primary').value;
        var country = document.getElementById('country-Primary').value;
      
        var billing_first = document.getElementById('billing_first_name');
        var billing_last = document.getElementById('billing_last_name');
        var billing_street = document.getElementById('billing_street_address-5');
        var billing_city = document.getElementById('billing_city-5');
        var billing_state = document.getElementById('billing_state_province_id-5');
        var billing_postal_code = document.getElementById('billing_postal_code-5');
        var billing_country = document.getElementById('billing_country_id-5');
      
        if (sameAsBilling.checked) {
          if (firstName) billing_first.value = firstName;
          if (lastName) billing_last.value = lastName;
          if (streetAddress) billing_street.value = streetAddress;
          if (city) billing_city.value = city;
          if (stateProvince) billing_state.value = stateProvince;
          if (postalCode) billing_postal_code.value = postalCode;
          if (country) billing_country.value = country;
        } else {
          billing_first.value = "";
          billing_last.value = "";
      ...
      <label for="same_as_billing">Billing address is the same as mailing address.</label>
